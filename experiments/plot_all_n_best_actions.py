...
root_folder = "multirun/2026-02-26"
...
for item in os.listdir(root_folder):
    ...
    if os.path.isdir(full_path):
        ...
        # --- Plot 1: Average Cost ---
        axes[0].set_title(f"Global Average Cost Over Time\n fingerRamp Cost method: {cfg.RRT.cost_method} n_best_actions: {cfg.RRT.n_best_actions}", fontweight='bold')
        ...
        save_path_base = f"/home/denis/Desktop/fingerRamp/n_best_action/{cfg.RRT.n_best_actions}"
        # 2. Save as .json
